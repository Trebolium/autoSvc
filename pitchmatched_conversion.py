...
import random, pdb, os, argparse, shutil, pickle, sys, csv, torch, yaml, importlib
...
def collect_feats_convert_synth(src_gender, trg_gender, self_convert):
...
parser.add_argument('-sc', '--self_convert', type=int, default=0)
...
codes_to_model = {'0':'damp_mel_Size0.25-avgEmbs_with-bestPerformingSIE_mel80-',
