...
if __name__ == "__main__":
    ...
    SIE_feats_params, SVC_feats_params = determine_dim_size(
        SIE_feats_params, SVC_feats_params, sie_feat_type, svc_feat_type, use_aper_feats
    )
    _, train_loader = load_primary_dataloader(
        SIE_feats_params,
        "train",
        SVC_feats_params,
        subset_size,
    ...
    _, val_loader = load_primary_dataloader(
        SIE_feats_params,
        "val",
        SVC_feats_params,
        subset_size,
