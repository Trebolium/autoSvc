...
ds_fn = f'{use_loader}_{feat_type}_Size{str(subset_size)}'
...
include_code_loss = True # dsicvoered this is necessary for good vc, so leave it in from now on
...
# svc_ckpt_path = os.path.join(SVC_models_dir, 'vctk_mel_Size1.0-avgEmbs_WithCcLoss-autoVc_pretrainedOnVctk_Mels80-trainUpTo300k', 'saved_model.pt')
svc_ckpt_path = ''
