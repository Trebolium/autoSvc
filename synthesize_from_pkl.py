...
parser.add_argument('-fd','--feat_dir', type=str, default='', help='Used as boolean. Determine whether the autosvc model used the old loss or the new loss (same to loss in autovc_basic)')
